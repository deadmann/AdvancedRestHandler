...
{
    /// <summary>
    /// Provides an instance of type <see cref="AdvancedRestHandler">AdvancedRestHandler</see> which is customized to handle <a href="https://en.wikipedia.org/wiki/Camel_case">CamelCase</a> property naming
    /// </summary>
    [SuppressMessage("ReSharper", "UnusedMember.Global")]
    [SuppressMessage("ReSharper", "RedundantBaseConstructorCall")]
    public class ArhCamelCaseWrapper : AdvancedRestHandler
    {
        ...
        public ArhCamelCaseWrapper(OverrideDirection direction = OverrideDirection.Both) : base()
        {
        ...
        /// <param name="direction">set the direction that this type of name handling should be applied to, for requests or response?</param>
        public ArhCamelCaseWrapper(string baseUrl, bool fixEndOfUrl = true,
        ...
        /// <param name="direction">set the direction that this type of name handling should be applied to, for requests or response?</param>
        public ArhCamelCaseWrapper(string baseUrl, RestHandlerInitializerOptions options,
